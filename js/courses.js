...
function Rendertogglearea(){
        ...
        const quizlens = quizs.length;
        var appendFile = '';
        for (k = 0 ; k < quizlens; k++){
            appendFile += 
            `<div id="specific1-w-node-_86f4356f-b9e5-12e3-8c89-35891eba50bb-bbbe96d4" class="w-layout-grid quiz-builder-question-wrap AddClass">
            ...
            <div id="specific2-w-node-_8db722d7-adae-2408-ef7c-7eefc014bb53-bbbe96d4_toggle" class="w-layout-grid quiz-builder-question-wrap AddClass" >
                    <div id="w-node-ef986d02-1c34-986b-3f96-b916195a7846-bbbe96d4" class="quiz-builder-question-number">
                        <div id="w-node-ef986d02-1c34-986b-3f96-b916195a7847-bbbe96d4">QH`+ (k + 1) +`</div>
                        </div>
           ...
           $(".grid-builder-questions .quiz-builder-question-wrap").parent('div').append(appendFile);
            const element = $(".grid-builder-questions");
            console.log("element", element)
            // element.find(">:first-child").remove();
            // element.find(">:nth-child(2)").remove();
            // element.find(">:nth-child(3)").remove();
        // });
}
